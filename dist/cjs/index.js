...
exports.ReactCreditCards = void 0;
...
const ORIGINAL_CARD_ARRAY = payment_1.default.getCardArray();
const ReactCreditCards = ({ issuer: _issuer, preview = false, acceptedCards = [], cvc, expiry: _expiry, focused, locale = {
    valid: "valid thru",
}, name = "John Doe", number, placeholders = {
    name: "John Doe",
}, onNumberClick, onCvvClick, onNameClick, onExpiryClick, }) => {
    const cardNumber = String(number);
    const inferredIssuer = payment_1.default.fns.cardType(cardNumber) || "unknown";
    ...
    react_1.default.useEffect(() => {
        if (Array.isArray(acceptedCards) && acceptedCards.length) {
            const newCardArray = [];
            for (const d of payment_1.default.getCardArray()) {
                if (acceptedCards.includes(d.type)) {
                    newCardArray.push(d);
                }
            }
            payment_1.default.setCardArray(newCardArray);
            return;
        }
        payment_1.default.setCardArray(ORIGINAL_CARD_ARRAY);
    }, [acceptedCards]);
    ...
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: "rccs" }, { children: (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: mainClassName }, { children: [(0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "rccs__card--front" }, { children: [(0, jsx_runtime_1.jsx)("div", { className: "rccs__card__background" }), (0, jsx_runtime_1.jsx)("div", { className: "rccs__issuer" }), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: cvcClassName, onClick: onCvvClick }, { children: cvc })), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: numberClassName, onClick: onNumberClick }, { children: numberToShow })), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: nameClassname, onClick: onNameClick }, { children: name || placeholders.name })), (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: expiryClassName, onClick: onExpiryClick }, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ className: "rccs__expiry__valid" }, { children: locale.valid })), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: "rccs__expiry__value" }, { children: expiry }))] })), (0, jsx_runtime_1.jsx)("div", { className: "rccs__chip" })] })), (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "rccs__card--back" }, { children: [(0, jsx_runtime_1.jsx)("div", { className: "rccs__card__background" }), (0, jsx_runtime_1.jsx)("div", { className: "rccs__stripe" }), (0, jsx_runtime_1.jsx)("div", { className: "rccs__signature" }), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: cvvClassName, onClick: onCvvClick }, { children: cvc })), (0, jsx_runtime_1.jsx)("div", { className: "rccs__issuer" })] }))] })) }), "Cards"));
};
exports.ReactCreditCards = ReactCreditCards;
exports.default = exports.ReactCreditCards;
